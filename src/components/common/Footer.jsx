...
const Footer = () => {
  ...
  // Makes social links work even if "https://" is not saved in admin
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.15fr_0.75fr_1.5fr] gap-12 lg:gap-16 items-start">
          ...
          <div>
            <Link
              ...
              aria-label="Go to IT Sparks Technologies homepage"
            >
              <img
                src={logo}
                ...
                width="160"
                height="160"
                className="h-14 w-auto bg-white rounded-button p-2 shrink-0 transition-transform duration-300 group-hover:scale-105"
              />

              <span className="font-extrabold text-xl leading-7 group-hover:text-primary transition-colors">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              {socialLinks.facebook && (
                <a
                  ...
                  title="Facebook"
                  className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary hover:-translate-y-1 transition-all duration-300 cursor-pointer"
                >
                  <svg
          ...
          <div>
            ...
            <div className="space-y-4 text-white/70">
              ...
              {settings?.phone && (
                <a
                  href={`tel:${getPhoneLink(settings.phone)}`}
                  className="flex gap-3 items-start w-fit hover:text-primary transition-colors group"
